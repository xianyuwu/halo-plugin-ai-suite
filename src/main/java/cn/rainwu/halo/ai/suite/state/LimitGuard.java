...
import cn.rainwu.halo.ai.suite.endpoint.UsageLimit.LimitDecision;
...
/**
 * 用量限流守卫 — 每次 LLM 调用前查 limits, 超限抛 {@link cn.rainwu.halo.ai.suite.endpoint.UsageLimit.LimitExceededException}.
 *
 * <p>检查顺序(任一超限即拒):
 * <ol>
